...
router.route("/pending/:userId")
    .get((req: Request, res: Response, next: NextFunction) => controller.findPendingByUser(req, res, next))
    
router.route("/completed/:userId")
    .get((req: Request, res: Response, next: NextFunction) => controller.findCompletedByUser(req, res, next))
